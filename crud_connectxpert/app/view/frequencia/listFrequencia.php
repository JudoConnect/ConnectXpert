...
<div class="container">
    ...
    <div class="row" style="margin-top: 10px;">
        <h3 class="col-12">Dados do Encontro</h3>
    </div>
        <div class="row" style="margin-top: 10px;">
        <div class="col-12">
            <span style="font-weight: bold; color: #ff7f32;">Nome: </span> <?= $dados["encontro"]->getNomeEncontro() ?>
        </div>
        <div class="col-12">
            <span style="font-weight: bold; color: #ff7f32;">Data: </span> <?= $dados["encontro"]->getDiaEncontroFormatada() ?>
        </div>
    </div>  
    ...
    <div class="row">
        <h3 class="col-12"> Frequência <a class="btn-inserir" 
