...
<h3 class="col-4">
    ...
    Encontro <a class="btn-inserir" href="<?= BASEURL ?>/controller/EncontroController.php?action=list"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16"  style="color: rgba(255, 127, 50, 1);" >
