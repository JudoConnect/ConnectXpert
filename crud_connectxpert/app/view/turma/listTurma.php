...
<div class="container">
    <div class="row">
        <h3 class="col-md-12">Turmas
            <a class="btn-inserir" href="<?= BASEURL ?>/controller/TurmaController.php?action=create">
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-12">
            <div class="table-responsive">
                <table id="tabTurmas" class='table table-striped'>
                    <thead>
                        <tr class="topicos">
                            <th>Nome Turma</th>
                    ...
                    <tbody>
                        <?php foreach ($dados['lista'] as $tur) : ?>
                            <tr class="listagem">
                                ...
                                <td><a class="btn-alterar" href="<?= BASEURL ?>/controller/TurmaProfessorController.php?action=list&id=<?= $tur->getIdTurma() ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                            <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                            <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z" />
                                        </svg> Professores</a>

                                <td><a class="btn-alterar" href="<?= BASEURL ?>/controller/TurmaAlunoController.php?action=list&id=<?= $tur->getIdTurma() ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                            <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                                            <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z" />
                                        </svg> Alunos</a>

                                <td><a class="btn-alterar" href="<?= BASEURL ?>/controller/TurmaController.php?action=edit&id=<?= $tur->getIdTurma() ?>">
                                ...
                                <td><a class="btn-excluir" onclick="return confirm('Confirma a exclusão da turma?');" href="<?= BASEURL ?>/controller/TurmaController.php?action=delete&id=<?= $tur->getIdTurma() ?>">
