...
<div class="container">
    <div class="row">
    <h3 class="col-4">
    <?php if($dados['id_aluno'] == 0) echo "Inserir "; else echo "Alterar"; ?> Aluno <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16" style="color: rgba(255, 127, 50, 1);">
