...
<div class="container">
    <div class="row">
        <h3 class="col-12">Alunos <a class="btn-inserir" href="<?= BASEURL ?>/controller/AlunoController.php?action=create">
                    ...
                    <tbody>
                        <?php foreach ($dados['lista'] as $aln) : ?>
                            ...
                            <tr class="listagem">
                                ...
                                <td><a class="btn-alterar" href="<?= BASEURL ?>/controller/AlunoController.php?action=edit&id=<?= $aln->getIdAluno() ?>">
                                ...
                                <td><a class="btn-excluir" onclick="return confirm('Confirma a exclusão do aluno? Ao excluir este aluno todos os dados atrelados a ele serão excluídos');" href="<?= BASEURL ?>/controller/AlunoController.php?action=delete&id=<?= $aln->getIdAluno() ?>">
