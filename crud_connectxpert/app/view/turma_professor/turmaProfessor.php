    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-12">
            <table id="tabProfessores" class='table table-striped'>
                    ...
                    <?php foreach($dados['listaProfessoresturma'] as $prof): ?>
                        <tr class="listagem">
                            ...
                            <td><a class="btn-excluir" 
                                ...
                                href="<?= BASEURL ?>/controller/TurmaProfessorController.php?action=delete&idTurmaProf=<?= $prof->getIdTurmaProfessor() ?>&idTurma=<?= $dados["turma"]->getIdTurma() ?>">
