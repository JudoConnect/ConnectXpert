...
<div class="container">
    <div class="row">
    <h3 class="col-4"> Vídeo Aula <a class="btn-inserir" 
                href="<?= BASEURL ?>/controller/VideoAulaController.php?action=create">
  ...
  <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                    ...
                    <?php foreach($dados['lista'] as $videoAula): ?>
                        <tr class="listagem">
                            ...
                            <td><a class="btn-alterar" 
                                href="<?= BASEURL ?>/controller/VideoAulaController.php?action=edit&id=<?= $videoAula->getIdVideoAula() ?>">
    ...
    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                            ...
                            <td><a class="btn-excluir" 
                                onclick="return confirm('Confirma a exclusão da Vídeo Aula?');"
                                href="<?= BASEURL ?>/controller/VideoAulaController.php?action=delete&id=<?= $videoAula->getIdVideoAula() ?>">
